...
app.get('/api/messages', (_, res) => res.json(require('./fixtures/messages')));
app.get('/api/users', (_, res) => res.json(require('./fixtures/users')));
app.get('/api/emoji', (_, res) => res.json(require('./fixtures/emoji')));
